/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4689144a72ab49a1d70f10280b5d241a)
...
interface __BaseEnv_Env {
	...
	CODEX_UPSTREAM_URL: string;
	CODEX_RELAY_URL?: string;
	ENABLE_CONTAINER_RELAY?: string;
	TOKEN_BROKER: DurableObjectNamespace<import("./src/index").TokenBroker>;
	UPSTREAM_RELAY: DurableObjectNamespace<import("./src/index").CodexUpstreamRelay>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "TokenBroker" | "CodexUpstreamRelay";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CODEX_OAUTH_TOKEN_URL" | "CODEX_OAUTH_CLIENT_ID" | "API_KEY_PEPPER" | "TOKEN_ENCRYPTION_KEY" | "CODEX_UPSTREAM_URL">> {}
}
